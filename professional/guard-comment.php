        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="core/comment_add.php">
                    ...
                    <div class="mb-3">
                        <input class="form-control" name="link" value="?status=guard" required hidden>
                    </div>
                    ...
                    <div class="mb-3">
                        <input class="form-control" name="comment_author_email" value="<?php echo $mail = permalink($comment_author) . randomservice(); ?>" required hidden>
                    </div>

                    <div class="mb-3 text-center">
                        <?php
                        echo "<b>".$comment_author . "</b> olarak <b>" . $mail . "</b> maili ile yorum atılacak.";
                        ?>
                    </div>
